  ...
  return (
    <div class="wideFooter">
      <div class="footer">
        ...
        <div class={`sponsors`}>
          <img  class="sponsor" src={`https://static.igem.wiki/teams/4629/wiki/chulalongkorn.png`}/> 
          <img class="sponsor" src={`https://static.igem.wiki/teams/4629/wiki/bangchak1.png`}/> 
          <img class="sponsor" src={`https://static.igem.wiki/teams/4629/wiki/mahachok.png`}/> 
          <img class="sponsor" src={`https://static.igem.wiki/teams/4629/wiki/ris.png`}/> 
