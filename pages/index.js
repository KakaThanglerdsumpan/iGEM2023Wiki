        ...
        <section class="pls1">
          <div class="masthead">
            ...
            <div class="text-container">
              <h1 class="text-white text-4xl sm:text-6xl">Thailand-RIS</h1>
        ...
        <section class="pls3">
          <div class="grid-container">
            ...
            <div class="grid-item">
              ...
              <h1 class="subtitl">plant stress response capabilities.</h1>
            </div>
            <div class="grid-item">
...
"
        ...
        <section class="pls4">
          <div class="absolute-center">
            <div>
              <h1 class="title">The difference between life and death:</h1>
