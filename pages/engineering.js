      ...
      <div class="row">
        <div class="contentsBar">
          <div style={{ position: "sticky", top: "200px" }} class="column">
            <h2 style={{ marginBottom: "20px" }}>Engineering</h2>
            <button
            ...
            <button
              class="contentsButton"
              onClick={() => handleClick("header5")}
            >
              Bacteria Transformation
            </button>
            <button
              class="contentsButton"
              onClick={() => handleClick("header6")}
            >
              Plant Transformation
            </button>
            <button
              class="contentsButton"
              onClick={() => handleClick("header7")}
            >
              Conditions/Treatment
            </button>
            <button
              class="contentsButton"
              onClick={() => handleClick("header8")}
            >
              &gamma;-EC Content Analysis
            </button>
            <button
              class="contentsButton"
              onClick={() => handleClick("header9")}
            >
              Statistical Analysis
            </button>
            <button
              class="contentsButton"
              onClick={() => handleClick("header10")}
            >
              Bibliography
            </button>
          </div>
        ...
        <div style={{ paddingTop: "60px" }} class="text">
          ...
          <h2 id="header3">
            <b>Vector Construction With Mitochondrial Transit Peptide</b>{" "}
          </h2>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;The amino acid sequence of DzGCL was
            obtained from the NCBI database (accession number: XP_022738907.1).
            The chloroplast transit peptide was predicted using TargetP-2.0{" "}
            <sup>[1]</sup> and then was removed from the full-length of DzGCL.
            The mitochondrial transit peptide from <i>Arabidopsis thaliana</i>{" "}
            Succinate dehydrogenase <sup>[2]</sup> was then inserted instead of
            the chloroplast transit peptide to obtain the completed sequence of
            DzGCL with the mitochondrial transit peptide (mDzGCL). This protein
            then was translated back into nucleotides and inserted in
            pCAMBIA1301. The complete construct was ordered from Biomatik
            company (USA). Read more in design.
          </p>
          <h2 id="header4">
            <b>Plant material and preparation</b>
          </h2>
          <p>
            ...
            planted individually into new pots and were grown under similar
            conditions.
          </p>
          <img
            class="figure"
          ...
          <p>
            ...
            <i>A. tumefaciens</i>, certain colonies were selected (Fig 1a).
          ...
          <p>
            ...
            the target DNA sequence. Figure 1b depicts a successful gel
          ...
          />
          <h5>
            <b>Figure 1.</b> (a) Bacteria colony growth on an agar medium with
            antibiotic , only transformed <i>A. tumefaciens</i> should be
            resistant to. and (b) Gel electrophoresis of the colony PCR for{" "}
            <i>mDzGCL</i>-pCAMBIA1301 plasmid.
          </h5>
          <h2 id="header6">
            <b>Plant Transformation</b>
          </h2>
          <p>
            ...
            plants were used.<sup>[3]</sup>. At least 4 leaves, considered as 4
            ...
            <ol type="a">
              <li>
                <p>
                  ...
                  receiving 16 hours of light and 8 hours of darkness while
                  being watered daily.
                </p>
              </li>
              <br></br>
              <li>
                <p>
                  Drought conditions were primarily simulated by not watering
                  the <i>N. benthamiana</i> plants, starting from the first day.
                  This was done immediately due to the previously wet soil
                  taking a set amount of time to fully dry. The plants were
                  still grown in the same temperatures and light/dark conditions
                  as the normal conditions.
                </p>
              </li>
              <br></br>
              <li>
                <p>
                  For the heat stress conditions, plants were grown under
                  25&deg;C receiving 16 hours of light and 8 hours of darkness
                  while being watered every day. After 5 days, the{" "}
                  <i>N. benthamiana</i> were placed in conditions under 30&deg;C
                  with 12/12 hours of light/dark. <i>mDzGCL</i> will not be
                  expressed until after 4 days, so variables are not introduced
                  until after that amount of time.
                </p>
              </li>
              <br></br>
              <li>
                <p>
                  ...
                  plants growing under 25&deg;C with 16/8 hours of light/dark
                  and daily watering. After 5 days, 30mL of 150 mM of NaCl was
                  added to the soil, and an additional 10mL every 2 days for a
                  total of 11 days.
                </p>
              </li>
            </ol>
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;The &gamma;-EC and GSH were extracted and
            analyzed by HPLC &apos;&apos;Metabolic variation in the pulps of two
            durian cultivars: Unraveling the &apos;&apos;<sup>[4]</sup>
          </p>
          <img
            class="figure"
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;Significance analysis of the corresponding
            experimental data was performed using T-test calculator (*p &lt;
            0.05).
          </p>
          ...
          <ol class="references">
            ...
            <li>
              ...
              dehydrogenase in Arabidopsis thaliana. Plant molecular biology.
              May 2001. Accessed June 15, 2023.
            ...
            <li>
              ...
              transcription factors. Nature News. August 20, 2019. Accessed June
              16. https://www.nature.com/articles/s41598-019-48601-7.
            </li>
            <li>
              ...
              October 8, 2023. https://doi.org/10.1016/j.foodchem.2018.06.066.
            </li>
          </ol>
          <div class="yBox100" />
        </div>
