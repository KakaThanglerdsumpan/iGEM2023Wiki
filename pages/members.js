function MembersPage({ children }) {
  const wideTitleScreenUrl = "https://static.igem.wiki/teams/4629/wiki/titlescreens/team.png";
      ...
      <div>
        ...
        <div class="membersWide sidePadded50">
          ...
          <h1 class="membersHeading"><u>Advisors & Instructors</u></h1>
            <center><p>
           &nbsp;&nbsp;&nbsp;&nbsp; Thailand-RIS extends our greatest gratitude to Chulalongkorn University and its esteemed professors for generously allowing us to utilize their lab and resources. 
        </p></center>
            {/* Teerapong Buaboocha */}
            <div class="leftRow memberCard">  
